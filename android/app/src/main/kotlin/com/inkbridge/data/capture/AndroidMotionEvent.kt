...
class AndroidMotionEvent(
    ...
    override fun getHistoricalAxisValue(axis: Int, pos: Int): Float =
        event.getHistoricalAxisValue(axis, 0, pos)

    override fun getHistoricalEventTime(pos: Int): Long =
